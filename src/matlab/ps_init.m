function enc = ps_init( Fs, adpcm_flag )
% PS_INIT Create an enc struct for sample rate Fs.
%
%   INPUTS
%   Fs: sample rate
%   adpcm_flag: 1 to use the ADPCM on the mono signal, 0 to leave it
%   	uncompressed.
...
% Low cutoff of the lowest band used in parameter calculations.  (Hertz)
...
% are we using NTD's ADPCM?
enc.adpcm = adpcm_flag;
